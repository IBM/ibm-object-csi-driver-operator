...
type IBMObjectCSISpec struct {
	...
	Installer *IBMObjectCSIInstallerSpec `json:"installer,omitempty"`
...
// IBMObjectCSIInstallerSpec defines the installer DaemonSet spec
type IBMObjectCSIInstallerSpec struct {
